...
public final class ExtraMath {
	...
	public static final java.text.DecimalFormat dfSc = new DecimalFormat("000.###E0");
	public static final java.text.DecimalFormat dfUs = new DecimalFormat("########.##");
	public static Random random;
	public static long xorRandomNum;
	/**
	...
	public static double troncateDigit(double value, int digits) {
	...
	public static double getFastUniRand() {
		double phi;
		//do {
			phi = randomLong()/10000f;
		//} while (Math.abs(phi)>2);
		return phi;
	}
	...
	public static double randomLong() {
		...
		xorRandomNum ^= (xorRandomNum << 21);
		xorRandomNum ^= (xorRandomNum >>> 35);
		xorRandomNum ^= (xorRandomNum << 4);
		  
		return (xorRandomNum%10000);
	}
	...
	public static double deviateFrom(double mu, double sigma) {
		...
		do {
			//I changed normRand to fastUniRand to save time
			deviation = getFastUniRand();
	...
	{
		random = r;
		xorRandomNum=5232552L * 2 * r.nextLong();
	}
